"""
Plot matrix based on JSON data written by hicma
...
options:
    ...
    --input JSON-file       Read input from the specified JSON file. This file
                            should be generated by hicma::write_JSON.
                            [default: matrix.json]
    --singular-values       Plot singular values instead of generic patch
                            representation
"""
...
def plot_lowrank(node, gs_node):
    dim = node['dim']
    svalues = [x+1e-10 for x in node['svalues']]
...
def main():
    ...
    plot_singular_values = args["--singular-values"]
    in_path = args["--input"]
