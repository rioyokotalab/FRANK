...
: dim(A.dim), start(A.start),
  rel_pos(A.rel_pos), abs_pos(A.abs_pos), block_dim(A.block_dim),
  parent(nullptr), children(A.children)
{
...
ClusterTree::ClusterTree(
  ...
  ClusterTree* parent
) : dim{n_rows, n_cols}, start{i_start, j_start},
