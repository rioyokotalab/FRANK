#ifndef FRANK_operations_randomized_factorizations_h
#define FRANK_operations_randomized_factorizations_h
...
#endif // FRANK_operations_randomized_factorizations_h
