 ...
 */
#ifndef FRANK_classes_initialization_helpers_index_range_h
#define FRANK_classes_initialization_helpers_index_range_h
...
#endif // FRANK_classes_initialization_helpers_index_range_h
