 ...
 */
#ifndef FRANK_classes_initialization_helpers_cluster_tree_h
#define FRANK_classes_initialization_helpers_cluster_tree_h
...
#endif // FRANK_classes_initialization_helpers_cluster_tree_h
